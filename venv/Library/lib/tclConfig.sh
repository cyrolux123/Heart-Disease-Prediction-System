...
# installed.
TCL_PREFIX='C:/Desktop/Heart Disease Prediction/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/Desktop/Heart Disease Prediction/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='C:/Desktop/Heart Disease Prediction/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/Desktop/Heart Disease Prediction/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/Desktop/Heart Disease Prediction/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='C:/Desktop/Heart Disease Prediction/venv\Library\lib\tclstub86.lib'
